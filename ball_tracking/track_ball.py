...
ballColorLower = (10,57,55)#(5,100,110) # (3,140,75)#(5,140,75)
ballColorUpper = (25,62,58)#(9, 165, 125) 


# ballColorLower = (123,66,49)
# ballColorUpper = (170,126,100) 
...
# video = 'nba-3d-data/2k_trim_1.mp4'
play_name = 'fist21'
video = 'nba-3d-data/harden/all_views.mp4'#'videos/2ktest.mp4'#spurs_play_'+play_name+'.mp4'
# video = 'nba-3d-data/harden/view_0/frame_%05d.png'
