...
args.cfg = 'configs/coco/resnet/256x192_res152_lr1e-3_1x-duc.yaml'
args.checkpoint = 'pretrained_models/fast_421_res152_256x192.pth'
args.inputpath = f'basketball/{args.player}/{args.view}'
args.outputpath = f'basketball/{args.player}/{args.view}_alphapose'
